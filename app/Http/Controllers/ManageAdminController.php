...
{	
    ...
    {
        $admin = Admin::find($id);
		return view('manageadmins.show',compact('admin')); //akan menampilkan show di manageadmins
    }
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request, [
		'name' => 'required',
		'email' => 'required|email|unique:users,email', //seharusnya unique:admins.email tapi karena dulu salah di databasenya makanya users, karena masuk ke users
		'job_title' => 'required',
